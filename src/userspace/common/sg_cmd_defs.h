...
X("configure security ips-profile",         "Create or edit IPS signature profiles",                   "configure,admin", -1, cmd_configure)
X("configure security ips-filter",          "Create or edit per-profile signature filters",            "configure,admin", -1, cmd_configure)
